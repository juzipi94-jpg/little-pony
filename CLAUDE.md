...
### 问题
多张目的地图片与实际内容不匹配：大理显示兵马俑、三亚显示珠峰大本营、拉萨显示江南水乡等。根本原因：之前只验证了 URL 返回 HTTP 200，未验证图片内容是否匹配目的地。

### 修复内容
- 共替换 57 处图片 ID（30 个全局替换 + 5 个规则特定修复 + 1 个 404 修复 + 1 个中东 404 修复）
- 涵盖 cityDB（20城）、getOrInitCity 规则（38条国内+国际规则）、首页卡片（5张）、resultData、detailData
- 所有 34 个新 ID 均通过 HTTP 200 验证（非 premium 图片）
- CLAUDE.md 映射表已同步更新

### 关键替换
| 目的地 | 旧 ID | 新 ID | 说明 |
|---|---|---|---|
| 大理 | `photo-1659466248885-8b7a03205661` | `photo-1725378812977-cc475abfa5a2` | 兵马俑→洱海 |
| 三亚 | `photo-1503641926155-5c17619b79d0` | `photo-1710428447167-ef713a6f42b9` | 珠峰→热带海滩 |
| 拉萨/西藏 | `photo-1556355549-6a9b0d79f59d` | `photo-1703842079863-20413f288d03` | 江南水乡→布达拉宫 |
| 丽江 | `photo-1692963507663-9edee478f46c` | `photo-1677922069750-944be2b9ad20` | →丽江古镇 |
| 重庆 | `photo-1716146705025-dadcab92b491` | `photo-1620321281938-2522ba59a1df` | →重庆夜景 |
| 昆明 | `photo-1626359909709-8067b64e1655` | `photo-1724130344214-d66eab70b1d2` | →昆明 |
| 哈尔滨 | `photo-1675522108963-c1ea024abb8a` | `photo-1716308352490-271359910f14` | →冰雪大世界 |
| 新疆 | `photo-1708789936160-8e3486358fdf` | `photo-1757069540493-8f74088b3269` | →天山 |
| 云南 | `photo-1633964528699-58ada2816ce1` | `photo-1776294984950-3f812aa0f797` | →梯田 |
| 南京 | `photo-1510001618818-4b4e3d86bf0f` | `photo-1589259411045-1841cec4f7a6` | →南京 |
| 长沙 | `photo-1508804185872-d7badad00f7d` | `photo-1583143574609-b2e508237650` | →长沙夜景 |
| 苏州 | `photo-1528181304800-259b08848526` | `photo-1745114392692-ede344e12e34` | →苏州园林 |
| 桂林 | `photo-1689825650048-55d2216868f7` | `photo-1773318901379-aac92fdf5611` | →喀斯特山水 |
| 草原 | `photo-1551986782-d0169b3f8fa7` | `photo-1755789450537-6e1838cb3558` | →草原蒙古包 |
| 欧洲/法国 | `photo-1502602898657-3e91760cbb34` | `photo-1679231926688-ef9cdab5ed2f` | →巴黎铁塔 |
| 东南亚 | `photo-1517411032315-54ef2cb783bb` | `photo-1563492065599-3520f775eeed` | →佛塔 |
| 日本 | `photo-1693858325816-b7a7c1066838` | `photo-1490806843957-31f4c9a91c65` | →富士山 |
| 韩国 | `photo-1570191913384-7b4ff11716e7` | `photo-1666670750287-176e3218ce12` | →景福宫 |
| 美国 | `photo-1486299267070-83823f5448dd` | `photo-1588384153148-ebd739ac430c` | →自由女神 |
| 澳洲 | `photo-1525625293386-3f8f99389edd` | `photo-1624138784614-87fd1b6528f8` | →悉尼歌剧院 |
| 迪拜 | `photo-1512453979798-5ea266f8880c` | `photo-1544092683-c0c9ebb368e5` | →迪拜塔 |
| 非洲 | `photo-1551986782-d0169b3f8fa7`（同草原） | `photo-1575550959106-5a7defe28b56` | →非洲safari |
| 冰岛 | `photo-1566296314736-6eaac1ca0cb9` | `photo-1531366936337-7c912a4589a7` | →极光 |
| 马尔代夫 | `photo-1518684079-3c830dcef090` | `photo-1573843981267-be1999ff37cd` | →水屋 |
| 新加坡 | `photo-1525625293386-3f8f99389edd`（同澳洲） | `photo-1552790920-0ba96dc99d01` | →鱼尾狮 |
| 土耳其 | `photo-1551918120-9739cb430c6d` | `photo-1604156789095-3348604c0f43` | →热气球 |
| 巴西/拉美 | `photo-1489392191049-fc10c97e64b6` | `photo-1518639192441-8fce0a366e2e` | →基督像 |
| 俄罗斯 | `photo-1662009867642-933d25d401fe` | `photo-1662679790388-e7b60d008ea0` | →圣瓦西里教堂 |
| 中东 | `photo-1567266565446-d9c40ccf59a4` | `photo-1549396535-c11d5c55b9df` | →中东清真寺 |
| 中亚 | `photo-1503806837798-ea0ce2e6402e` | `photo-1744177332411-9a57cd922af7` | →中亚 |
| 东欧 | `photo-1528127269322-539801943592` | `photo-1518471152222-d42e38ce6873` | →布达佩斯 |
| 加拿大 | `photo-1513326738677-b964603b136d` | `photo-1587381419916-78fc843a36f8` | →落基山脉 |
| 黄山（徽派规则） | 共享苏州旧 ID | `photo-1568454158153-6bf6cfda9070` | →黄山 |
| 敦煌（丝路规则） | 共享新疆旧 ID | `photo-1507169820737-80f8c50e81f7` | →敦煌 |

### 经验教训
- **HTTP 200 ≠ 图片正确**：验证 URL 可访问只是第一步，必须确认图片内容与目的地匹配
